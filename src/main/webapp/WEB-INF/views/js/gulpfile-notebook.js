...
gulp.task('rjs', function () {
    return gulp.src(jsSrc)
        .pipe(requirejsOptimize({
            ...
            exclude: ['jquery', 'bootstrap', 'handlebars', 'layer1', 'laydate', 'pagination', 'html5shiv.min', 'respond.min', 'jquery.validate', 'jquery.placeholder', 'ueditor.config', 'ueditor', 'zeroClipboard', 'jquery.ui']
        }))
