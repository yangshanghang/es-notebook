define(['client/note/model/listModel', 'common/util', 'layer1', 'handlebars', 'common/hbsHelper', 'pagination'], function (model, util, layer, handlebars) {
        var pageSize = 10;
            ...
            util.bindEvents([
                {
                    ...
                    event: 'click',
                    handler: function () {
                        _getNoteList(0, $(".js-type[js-type='1']").attr('js-category-id'));
                    }
                }, {
                    el: '#queryParam',
                    event: 'keypress',
        ...
        function _initParamGetNote(pageNum, categoryId) {
            if (categoryId) {
                _getNoteList(pageNum, categoryId);
            } else {
                _getNoteList(pageNum);
            }
        }
         ...
         * @private
         */
        function _getNoteList(pageNum, categoryId) {
