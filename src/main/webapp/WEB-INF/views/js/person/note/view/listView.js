define(['person/note/model/listModel', 'common/util','layer1', 'handlebars', 'common/hbsHelper', 'pagination'], function (model, util,layer, handlebars) {
    var pageSize = 10;
