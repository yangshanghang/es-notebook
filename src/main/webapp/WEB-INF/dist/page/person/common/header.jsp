...
<div class="top-menu bg-blue">
    ...
    <div class="">
        <ul class="menu-list">
            <li><a href="<c:url value='/client/note/list'/>" <c:if test="${param.cur == 'index'}"> class="cur"</c:if>>检索中心</a></li>
            <li><a href="<c:url value='/client/columns/list'/>" <c:if test="${param.cur == 'columns'}"> class="cur"</c:if>>专栏中心</a></li>
            <li><a href="<c:url value='/person/note/list'/>" <c:if test="${param.cur == 'myNote'}"> class="cur"</c:if>>我的笔记</a></li>
        </ul>
