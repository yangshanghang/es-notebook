...
<div class="mod-1200 clearfix">
    <div class="fl mod-930 jszx-detail mr20">
        ...
        <div class="cont">
            ...
            <c:if test="${!empty prevNext && (columns.visibleStatus==0 || SESSION_USER_INFO.id==note.userId)}">
                ...
                <div class="js-comments">
                    <ul>
                        <c:forEach items="${comments}" var="comment">
                            <div class="js-commentDiv pos_rel">
    ...
    <div class="fl mod-240 pt119 related-articles sidebar-min-h">
    ...
    <script src="<c:url value='/js/client/note/controller/detailController.js?v=727b13019f'/>"></script>
</body>
</html>
